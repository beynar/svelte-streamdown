...
export const CodeBlock = ({
	...
	return (
		<CodeBlockContext.Provider value={{ code }}>
			...
			>
				<div
					className="flex items-center justify-between bg-gray-100/80 p-3 text-xs text-gray-600"
...
export const CodeBlockDownloadButton = ({
	...
	return (
		<button
			className={cn(
				'cursor-pointer p-1 text-gray-600 transition-all hover:text-gray-900',
				className
			)}
