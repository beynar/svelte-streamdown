...
export const TableCopyButton = ({
	...
	return (
		<button
			className={cn(
				'text-muted-foreground hover:text-foreground cursor-pointer p-1 transition-all',
				className
			)}
...
export const TableDownloadDropdown = ({
	...
	return (
		<div className="relative" ref={dropdownRef}>
			...
			{isOpen && (
				<div className="border-border absolute top-full right-0 z-10 mt-1 min-w-[120px] rounded-md border bg-white shadow-lg">
					<button
						className="hover:bg-muted/40 w-full px-3 py-2 text-left text-sm transition-colors"
