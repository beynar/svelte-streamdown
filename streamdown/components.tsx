...
export const components: Options['components'] = {
	...
	thead: ({ node, children, className, ...props }) => (
		<thead className={cn('bg-muted/80', className)} data-streamdown="table-header" {...props}>
			{children}
		</thead>
	),
	tbody: ({ node, children, className, ...props }) => (
		<tbody
			className={cn('divide-border bg-muted/40 divide-y', className)}
	...
	tr: ({ node, children, className, ...props }) => (
		<tr className={cn('border-border border-b', className)} data-streamdown="table-row" {...props}>
			{children}
		</tr>
	),
