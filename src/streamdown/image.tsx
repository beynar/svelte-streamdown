...
export const ImageComponent = ({ node, className, src, alt, ...props }: ImageComponentProps) => {
	...
	return (
		<div className="group relative my-4 inline-block" data-streamdown="image-wrapper">
			...
			<button
				className={cn(
					'absolute right-2 bottom-2 flex h-8 w-8 cursor-pointer items-center justify-center rounded-md border border-gray-200 bg-white/90 shadow-sm backdrop-blur-sm transition-all duration-200 hover:bg-white',
